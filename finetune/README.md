...
Train small language models to expand search queries for [MinerU Document Explorer](https://github.com/opendatalab/MinerU-Document-Explorer)'s hybrid retrieval pipeline.
